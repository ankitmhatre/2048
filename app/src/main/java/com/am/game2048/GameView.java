...
import com.am.game2048.GameGrid.DIRECTION;
...
long resetTimer =0;
    ...
    public GameView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.com_am_game2048_GameView,
                0, 0);

        try {
            backgroundColor = Color.parseColor( a.getString(R.styleable.com_am_game2048_GameView_backgroundColor ));

            mainRectColor = Color.parseColor( a.getString(R.styleable.com_am_game2048_GameView_foregroundColor) );
            mainRectRoundAngles = a.getInteger(R.styleable.com_am_game2048_GameView_roundAngles, 0);

            gridRectColor = Color.parseColor( a.getString(R.styleable.com_am_game2048_GameView_gridColor) );
            gridSpacing = a.getInteger(R.styleable.com_am_game2048_GameView_gridSpacing, 0);
            gridMargins = a.getInteger(R.styleable.com_am_game2048_GameView_gridMargins, 1);

            tileView = new DefaultTileView(context, a.getInteger(R.styleable.com_am_game2048_GameView_roundTileAngles, 0));
        } finally {
            a.recycle();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (model.getGameState() != GameGrid.GAMESTATE.PLAY) {
            ...
            if (animFadeGameover > 10) {
                ...
                resultPaint.setTextSize(72); // TODO: make pixel-independent
...
//        if(resetTimer==0){
//            canvas.drawText("Tap to restart", mainRect.centerX()- mainRect.centerX(), mainRect.centerY()+fontHeight*-1, resultPaint);
//
//        }
    }
        ...
        if(model.getGameState() == GameGrid.GAMESTATE.GAMEOVER){
          ...
          Runnable r =   new Runnable(){
                ...
                public void run() {
                    ...
                    model.doNewGame(animList);
                }
            };
            new Handler().postDelayed(r, resetTimer);
            Log.d("2048game", "touch " + gameResetDownTime + " action=" +  ev.getAction());
//            if (ev.getAction() == MotionEvent.ACTION_DOWN) {
//                gameResetDownTime = System.currentTimeMillis();
//                Log.d("2048game", "gameResetDownTime " + gameResetDownTime);
//            }
//
//
//            if (ev.getAction() == MotionEvent.ACTION_UP) {
//                long diff = System.currentTimeMillis() - gameResetDownTime;
//                Log.d("2048game", "gameResetUpTime " + diff);
//                if(diff > 2000L){
//                    this.model.doNewGame(null);
//                }
//            }
